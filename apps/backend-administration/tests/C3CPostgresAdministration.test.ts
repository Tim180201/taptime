...
beforeAll(async () => {
  ...
  await expect(migrate(installerPool)).resolves.toEqual({
    applied: ['001', '002', '003', '004', '005', '006', '007', '008', '009', '010'],
    alreadyApplied: [],
  });
...
describe('migration 007, roles and database contracts', () => {
  it('records exactly immutable migrations 001 through 010 and reruns without changes', async () => {
