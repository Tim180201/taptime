...
describe('versioned B4 migration', () => {
  it('applies the current migrations 001 through 006 once and records the immutable ledger', async () => {
    ...
    expect(rerun).toEqual({ applied: [], alreadyApplied: ['001', '002', '003', '004', '005', '006'] });
  });
});
