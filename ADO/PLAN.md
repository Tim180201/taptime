...
Naechste Reihenfolge: **T-067** (Deploy laeuft) → **T-065** → **T-066** → **T-068** → Deploy →
Pilot Monat 1;
...
| **T-066** | **Zeit nachtragen und Kommentar (D-067, D-069)** | Mitarbeiter traegt im laufenden und im Vormonat nach, zaehlt sofort, markiert „nachgetragen"; Administrator und Standortleitung ohne Grenze mit Grund; Kommentar je Zeiteintrag, Historie erhalten, im Export. Einstieg: Knopf „Zeit hinzufuegen" in Meine Zeiten; Kommentar an jedem Eintrag der Tagesansicht. Backend, App, Web. Vor dem Pilotstart. | 2 |
