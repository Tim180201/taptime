...
**Stand:** 18.09.2026, Produktion auf `939b4ba`, `main` auf `91441c8` (T-058, T-043, T-060,
T-059) — vier Aufgaben vor der Produktion. Naechste Reihenfolge: **Deploy** → neue APK →
Geraeteabnahme (D-044) → T-049 → Pilot Monat 1; waehrend Monat 1 T-048 und T-050, Freigabe zu
