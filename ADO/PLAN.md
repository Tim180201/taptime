...
**Stand:** 18.09.2026, Produktion auf `91441c8`; auf `main` zusaetzlich T-061 (`d5a58a6`)
und T-049 (`adc7258`, Metro-Reparatur `dcdaebb`), CI gruen. APK VersionCode 7 am Geraet
abgenommen (D-044).
Naechste Reihenfolge: **T-063** (archive_timeout) → **ein** Deploy fuer T-061/T-049/T-063 →
Abnahme Web und Geraet → Pilot Monat 1; waehrend Monat 1 T-048 und T-050, Freigabe zu
