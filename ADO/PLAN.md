...
| **T-032** | **Die App bekommt das Raster und spürbare Rückmeldung** | Gemessen am 28.08.: 15 React-Native-Standardknöpfe, feste **helle** Farbwerte im Quelltext statt des Rasters aus D-031, und **null Haptik, null Ton, null Animation**. Der Kern: Wer ein Telefon an einen Tag hält, **sieht den Bildschirm nicht**. Unterscheidbares Vibrieren und ein kurzer Ton für Arbeit, Pause und Fehlschlag erreichen die Person; eine Animation nicht. Optik zweitrangig, Rückmeldung zuerst. | 3 |
