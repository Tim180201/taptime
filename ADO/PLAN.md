...
vom 24.09. abgenommen. Naechste Reihenfolge (PO 24.09., D-091): T-077 ✓ und T-076 ✓ auf `main` → **T-062** (Standortleitung im eigenen
Standort, vorgezogen) → Deploy mit Migration 033 → ein App-Build fuer iPhone und Android mit Geraeteabnahme → **T-024** →
