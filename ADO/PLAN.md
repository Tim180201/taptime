...
| **T-052** | **Die Bestaetigung kommt zurueck in den Tap (D-052)** | `archive_pending` traegt heute keine Entscheidung; der Vertrag v4 muss Entscheidung bzw. Pruefgrund auch im noch nicht archivierten Fall fuehren. Der Scheduler zeigt und fuehlt sie sofort, quittiert die Zeile aber nicht und behaelt sie bis zum Archivnachweis. Die Oberflaeche braucht einen eigenen Zustand "bestaetigt, Sicherung laeuft" statt des Warntons "Sicher lokal gespeichert". Gegenbeweis bleibt: Commit ohne Archivnachweis loescht die Zeile nicht. **Vor dem Deploy von T-035**, solange v4 noch nie ausgeliefert wurde. | — |
