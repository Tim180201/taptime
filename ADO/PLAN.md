...
**Stand:** 15.09.2026, Reihenfolge aus der vollständigen Anforderungsprüfung gegen den Code
(D-012).
...
| **T-045** | **Der startausloesende Intent gehoert zur neuen Berechtigung — aktuell** | Der Intent, der den Prozess gestartet hat, wird genau einmal unter der durch diesen Start entstandenen Berechtigung verarbeitet. Erfassungen unter anderer Mitgliedschaft oder Identitaet, aus einem frueheren Geraetestart oder ohne belastbaren Startbezug bleiben ausgeschlossen. Kriterium und eine etwaige Zeitschranke werden aus ihrer Quelle begruendet; `singleTop`, Vordergrundverhalten und `ExclusiveNfcCaptureArbiter` werden ausdruecklich geprueft. | 1 |
