...
| **T-033** | **Gerätetest der Android-APK durch den Product Owner — aktuell** | Die intern installierbare APK trägt den Quellstand `2b0a5573`. T-034 (`56e975a`) hat `apps/mobile` nicht verändert; kein Neubau. Der Product Owner prüft den vollständigen Weg am echten Gerät nach `ADO/04_Operations/Android_Produktionstest.md`. | PO |
