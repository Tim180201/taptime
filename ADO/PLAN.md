...
**Stand:** 18.09.2026, Produktion auf `939b4ba`, `main` auf `b68e48b` (T-058, T-043). Naechste
Reihenfolge (D-058, D-060): T-060 → T-059 → neue APK → T-049 → Pilot. Grundlage weiterhin die Anforderungspruefung gegen den Code (D-012).
