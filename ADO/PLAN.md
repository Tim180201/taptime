...
P1: die Standortleitung bekommt in der App keine Offline-Freigabe. Naechste Reihenfolge (TL 25.09.): **T-080** (Standortleitung
scannt) → ein App-Build → Rest der Geraeteabnahme → **T-024** → Pilot Monat 1. In Monat 1 zusaetzlich T-075 (Paketgrenze, D-087)
