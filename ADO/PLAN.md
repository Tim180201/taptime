...
| **T-043** | **Der Tag startet die App — aktuell, zuerst nur Diagnose** | Paketauflösung für NDEF, TECH und TAG einzeln belegen; Auswahl von TapTim.e praktisch prüfen; tatsächlichen Intent, NDEF-Inhalt und Tag-Technologien feststellen; `TECH_DISCOVERED`-Kategorie gegen offizielle Dokumentation und Gerät prüfen. Erst berichten, dann eine einzelne Reparatur beauftragen. | 1 |
