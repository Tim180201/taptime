...
| **T-035** | **Kein stiller Datenverlust (B05, B03) — aktuell** | Vor B05 entscheidet der Product Owner Verlustgrenze und Wiederanlaufzeit nach Vergleich von fortlaufender Archivierung, befristetem Telefon-Zweitstück und begründeten Alternativen. B03 bekommt den fehlenden Wecker im `retry_wait`-Zweig sowie einen Regressionstest mit kontrollierter Uhr, echtem Datenbank-Fälligkeitsverhalten, zweitem Auslöser vor Fälligkeit und Pflicht-Gegenbeweis. | — |
