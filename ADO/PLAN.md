...
vom 24.09. abgenommen. Naechste Reihenfolge (PO 24.09.): **T-077** (Meine Zeiten fuer Administrator und Standortleitung,
D-090) → **T-076** (Kontowechsel am Geraet) → ein App-Build fuer iPhone und Android mit Geraeteabnahme → **T-024** →
Pilot Monat 1. In Monat 1 zusaetzlich T-075 (Paketgrenze, D-087).
