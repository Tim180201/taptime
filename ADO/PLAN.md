...
| **T-046** | **Der Einrichtungsvertrag traegt Pausen-Tags und beschaedigte Einzelzeilen — aktuell** | V1 bleibt ruecknehmbar, V2 traegt den Zuordnungstyp. Ein gemeinsamer Nahttest prueft die echte Backend-Antwort gegen den Web-Parser. Fehlerhafte Listenzeilen lassen den Rest sichtbar und markieren die Anzahl als unvollstaendig; eine fehlerhafte Huelle bleibt fail closed. Netzfehler und unverwertbare Antworten erhalten verschiedene Meldungen. | 1 |
...
| **T-051** | **Vorschlag: Ueberstunden und Urlaub — bewusst geparkt** | Beides braucht ein Soll-Modell, das es nicht gibt: vereinbarte Arbeitszeit, Arbeitszeitkonto, Urlaubsanspruch, Abwesenheiten, Jahresuebertrag. Eigenes Vorhaben, kein Reiter. **Noch keine Entscheidung.** Eigene Stunden im laufenden Monat gehoeren dagegen in die Uebersicht und sind einfach. | — |
