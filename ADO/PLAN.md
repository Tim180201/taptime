...
| **T-034 ✓** | **Beweisbarer Betrieb (B01, B04) — abgeschlossen (`56e975a`, CI und vollständiger Image-Bau grün)** | Das Admin-Web-Abbild entsteht nur mit öffentlicher Anmeldekonfiguration; das Auslieferungstor prüft das echte Bündel. Die Restore-Prüfung leitet die RLS-Bedingung aus allen vorhandenen Anwendungstabellen ab. | — |
...
| **T-033** | **Die App kommt aufs Gerät — zurückgestellt** | Nach T-034 und T-038: Den sauberen Code-Stand `846a126` mit dem nachgeschlagenen EAS-Profil als intern installierbare Android-APK bauen und den Link persönlich an den Product Owner geben. | 1 |
