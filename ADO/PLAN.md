...
| **T-052** | **Die Bestaetigung kommt zurueck in den Tap (D-052, neu zugeschnitten)** | Entscheidung zeigen und Uebertragung weiterruecken sofort nach Serverbestaetigung. Unarchivierte Zeilen getrennt aufbewahren; ein eigener ruhiger Reconciliation-v2-Nachlauf loescht erst nach Archivnachweis. Bestaetigte Zeilen zaehlen nicht als offene Uebertragung. Vertrag, verpflichtender Abgleich und Lease-Client-Rueckbau bleiben. Restore-Befunde sind T-055. Echter SQLite-Gegenbeweis fuer den zweiten Tap. | — |
