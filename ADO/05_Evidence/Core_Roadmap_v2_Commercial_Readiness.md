...
only the local harness and Human observations remain gated.
...
The current engineering critical path is C3E1 harness exact-head CI/independent review and its fresh
Human Gate, C3E2 policy/authorization, the
