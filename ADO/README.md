...
A focused Validation-specific Phase-0 operator candidate now exists on baseline `39a6ef0`:
...
**PENDING independent re-review/CI — DO NOT START**. This candidate grants no Phase-0,
