...
DT-060–DT-062 CLOSURE APPROVED FOR THE AUTHORIZED LOCAL SCOPE; CLOSURE PUBLICATION `715889e`,
TREE `b9fc3ac`, AND EXACT-HEAD RUN `29837556200` 10/10; DA1 CLOSED; PRODUCTION, PRODUCTION DATA,
...
AUTHORIZED LOCAL SCOPE. CLOSURE PUBLICATION `715889e`, TREE `b9fc3ac`, PASSED EXACT-HEAD RUN
`29837556200`, ATTEMPT 1, TEN OF TEN. DA1 IS CLOSED FOR THAT SCOPE.
...
authorized local Android/repository/synthetic-server scope. Closure publication `715889e`, tree
`b9fc3ac`, passed exact-head run `29837556200`, attempt 1, ten of ten; DA1 is closed for that scope.
